INFORMATION ABOUT BHUVAN API'S
...
Response body
  ...
  "data": {
    ...
    "summary": {
      ...
      "total_segments": 3,
      "start_point": {
        "lng": 77.5946470000001,
        "lat": 12.9718560000001
      },
      "end_point": {
        "lng": 76.639578,
        "lat": 12.2957200000001
      }
    }
  },
  "error": null
...
Response headers
        ...
        content-type: application/json; charset=utf-8 
        cross-origin-opener-policy: same-origin 
        date: Sat,27 Sep 2025 18:01:28 GMT 
        referrer-policy: same-origin 
        server: WSGIServer/0.2 CPython/3.12.4 
        x-content-type-options: nosniff 
        x-frame-options: DENY 
...
7./api/postal_hospital_proximity 
...
Curl
        ...
        curl -X 'POST' \
        'http://127.0.0.1:8000/api/postal_hospital_proximity' \
        -H 'accept: application/json' \
        -H 'Content-Type: application/json' \
        -d '{
        "coordinates": {
...
Response body
        ...
        {
        "data": {
            "timestamp": "2025-09-27T23:46:24.579453",
            "coordinates": {
            "lat": 13.0731,
            "lng": 77.5901
            },
            ...
            "buffer": 3000,
            "theme": "all",
            "token": "69f890a8dc5725a7dfb7bb000ac5b58ed58a26a7"
            },
            "proximity_data": null,
            "summary": {
            "total_facilities": 0,
...
Response headers
        ...
        content-type: application/json; charset=utf-8 
        cross-origin-opener-policy: same-origin 
        date: Sat,27 Sep 2025 18:16:24 GMT 
        referrer-policy: same-origin 
        server: WSGIServer/0.2 CPython/3.12.4 
        x-content-type-options: nosniff 
        x-frame-options: DENY 
...
Response headers
 ...
 9. /api/village_reverse_geocoding
...
Response headers
        ...
        content-type: application/json; charset=utf-8 
        cross-origin-opener-policy: same-origin 
        date: Sat,27 Sep 2025 18:15:23 GMT 
        referrer-policy: same-origin 
        server: WSGIServer/0.2 CPython/3.12.4 
        x-content-type-options: nosniff 
        x-frame-options: DENY 